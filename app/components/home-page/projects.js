...
export default class ProjectsComponent extends Component {
  ...
  projects = [
    ...
    },
    {
      ...
      desc:
        "For human-computer interaction class, I developed a program for the Leap Motion that teaches the user the first ten digits of American Sign Language. I tracked the position of the joints in their hand and predicted and verified their input based on set data using the k-NN algorithm. The program was designed to be intuitive by using visual affordances without the need for explicit instruction.",
    ...
    },
    {
      ...
      desc:
        "My internship with Bear Code had me develop a parallax website for the US Vote Foundation. I learned how to use git and to work with a team of mentors to meet the client's specifications. Learning to build a parallax site helped in the creation of my own website.",
